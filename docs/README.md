...
- [`docs/file-transfer-implementation.md`](file-transfer-implementation.md): current V4 single-file transfer protocol, data session, flow control, safety, and diagnostics design.
