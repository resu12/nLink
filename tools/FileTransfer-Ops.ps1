...
function Write-FileTransferSupportCaptureInstructions {
    ...
    Write-Host "7. Live NKN soak artifacts also include filetransfer-live-nkn-summary.txt, filetransfer-live-nkn-summary.json, filetransfer-live-nkn-cycles.jsonl, regular-nkn-passive-scout-summary.txt, regular-nkn-passive-scout-summary.json, and baseline-comparison.txt."
