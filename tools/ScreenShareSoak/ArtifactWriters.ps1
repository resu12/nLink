function Write-SoakDiagnosticsArtifacts {
    ...
    $helperQualitySummary = @(
        ...
        ("late_fragment_after_successful_recovery_count={0}" -f $Summary.LatestHelperLateFragmentAfterSuccessfulRecoveryCount),
        ("h264_reference_taint_active={0}" -f $Summary.LatestHelperH264ReferenceTaintActive),
        ("h264_reference_taint_enter_count={0}" -f $Summary.LatestHelperH264ReferenceTaintEnterCount),
        ("h264_reference_taint_release_count={0}" -f $Summary.LatestHelperH264ReferenceTaintReleaseCount),
        ("h264_reference_taint_last_reason={0}" -f $Summary.LatestHelperH264ReferenceTaintLastReason),
        ("h264_reference_taint_dropped_non_key_count={0}" -f $Summary.LatestHelperH264ReferenceTaintDroppedNonKeyCount),
        ("h264_reference_taint_decoder_reset_count={0}" -f $Summary.LatestHelperH264ReferenceTaintDecoderResetCount),
        ("h264_reference_taint_stale_visible_stable_enter_count={0}" -f $Summary.LatestHelperH264ReferenceTaintStaleVisibleStableEnterCount),
        ("stale_normal_non_key_visible_suppress_count={0}" -f $Summary.LatestHelperStaleNormalNonKeyVisibleSuppressCount),
        ("decoded_stale_visible_suppress_count={0}" -f $Summary.LatestHelperDecodedStaleVisibleSuppressCount),
        ("post_quarantine_settle_suppress_count={0}" -f $Summary.LatestHelperPostQuarantineSettleSuppressCount),
        ("h264_reference_quarantine_active={0}" -f $Summary.LatestHelperH264ReferenceQuarantineActive),
        ("h264_reference_quarantine_release_blocked_count={0}" -f $Summary.LatestHelperH264ReferenceQuarantineReleaseBlockedCount),
        ("h264_reference_quarantine_last_blocker={0}" -f $Summary.LatestHelperH264ReferenceQuarantineLastBlocker),
        ("h264_reference_quarantine_quiet_release_count={0}" -f $Summary.LatestHelperH264ReferenceQuarantineQuietReleaseCount),
        ("cursor_delivery_mode={0}" -f $Summary.LatestHelperCursorDeliveryMode),
        ("cursor_overlay_visible={0}" -f $Summary.LatestHelperCursorOverlayVisible),
        ("cursor_overlay_updates_received_count={0}" -f $Summary.LatestHelperCursorOverlayUpdatesReceivedCount),
        ("cursor_overlay_updates_applied_count={0}" -f $Summary.LatestHelperCursorOverlayUpdatesAppliedCount),
        ("cursor_overlay_update_hz={0}" -f $Summary.LatestHelperCursorOverlayUpdateHz),
        ("cursor_overlay_last_age_ms={0}" -f $Summary.LatestHelperCursorOverlayLastAgeMs),
        ("cursor_overlay_stale_count={0}" -f $Summary.LatestHelperCursorOverlayStaleCount),
        ("cursor_overlay_last_status={0}" -f $Summary.LatestHelperCursorOverlayLastStatus),
        '',
        'helper_quality_summary_lines:'
    ) + @($Summary.HelperQualitySummaryLines) + @(
        '',
        'helper_h264_reference_taint_summary_lines:'
    ) + @($Summary.HelperH264ReferenceTaintSummaryLines)
    ...
    $senderCadenceSummary = @(
        ...
        ("raw_capture_event_count={0}" -f $Summary.LatestRawCaptureEventCount),
        ("raw_frames_skipped_before_encode={0}" -f $Summary.LatestRawFramesSkippedBeforeEncode),
        ...
        ("raw_source_frame_arrived_count={0}" -f $Summary.LatestRawSourceFrameArrivedCount),
        ("raw_source_frames_skipped_before_readback={0}" -f $Summary.LatestRawSourceFramesSkippedBeforeReadback),
        ("raw_source_frames_readback_count={0}" -f $Summary.LatestRawSourceFramesReadbackCount),
        ("raw_source_readback_fps={0}" -f $Summary.LatestRawSourceReadbackFps),
        ("raw_source_last_readback_duration_ms={0}" -f $Summary.LatestRawSourceLastReadbackDurationMs),
        ("raw_source_avg_readback_duration_ms={0}" -f $Summary.LatestRawSourceAvgReadbackDurationMs),
        ("raw_source_cadence_target_fps={0}" -f $Summary.LatestRawSourceCadenceTargetFps),
        ("raw_source_urgent_bypass_count={0}" -f $Summary.LatestRawSourceUrgentBypassCount),
        ("raw_source_output_width={0}" -f $Summary.LatestRawSourceOutputWidth),
        ("raw_source_output_height={0}" -f $Summary.LatestRawSourceOutputHeight),
        ("raw_source_gpu_scale_enabled={0}" -f $Summary.LatestRawSourceGpuScaleEnabled),
        ("raw_source_gpu_scale_fallback_reason={0}" -f $Summary.LatestRawSourceGpuScaleFallbackReason),
        ("actual_encoded_displayable_fps={0}" -f $Summary.LatestActualEncodedDisplayableFps),
        ("encode_cadence_target_fps={0}" -f $Summary.LatestEncodeCadenceTargetFps),
        ("sender_process_cpu_percent={0}" -f $Summary.LatestSenderProcessCpuPercent),
        ("last_preprocess_duration_ms={0}" -f $Summary.LatestLastPreprocessDurationMs),
        ("last_preprocess_resize_duration_ms={0}" -f $Summary.LatestLastPreprocessResizeDurationMs),
        ("last_preprocess_color_convert_duration_ms={0}" -f $Summary.LatestLastPreprocessColorConvertDurationMs),
        ("preprocess_resize_path={0}" -f $Summary.LatestPreprocessResizePath),
        ("preprocess_direct_nv12_count={0}" -f $Summary.LatestPreprocessDirectNv12Count),
    ...
    $qualityPresentationSummary = @(
        ...
        ("motion_integrity_guard_active={0}" -f $Summary.LatestMotionIntegrityGuardActive),
        ("motion_integrity_sampled_ratio={0}" -f $Summary.LatestMotionIntegritySampledRatio),
        ("motion_integrity_peak_sampled_ratio={0}" -f $Summary.LatestMotionIntegrityPeakSampledRatio),
        ("motion_integrity_scroll_active_band_count={0}" -f $Summary.LatestMotionIntegrityScrollActiveBandCount),
        ("motion_integrity_scroll_peak_band_ratio={0}" -f $Summary.LatestMotionIntegrityScrollPeakBandRatio),
        ("motion_integrity_high_motion_frame_count={0}" -f $Summary.LatestMotionIntegrityHighMotionFrameCount),
        ("motion_integrity_scroll_trigger_count={0}" -f $Summary.LatestMotionIntegrityScrollTriggerCount),
        ("motion_integrity_burst_enter_count={0}" -f $Summary.LatestMotionIntegrityBurstEnterCount),
        ("motion_integrity_burst_exit_count={0}" -f $Summary.LatestMotionIntegrityBurstExitCount),
        ("motion_integrity_forced_keyframe_count={0}" -f $Summary.LatestMotionIntegrityForcedKeyFrameCount),
        ("motion_integrity_last_trigger_kind={0}" -f $Summary.LatestMotionIntegrityLastTriggerKind),
        ("motion_integrity_last_reason={0}" -f $Summary.LatestMotionIntegrityLastReason),
        ("motion_integrity_idr_frame_ratio={0}" -f $Summary.LatestMotionIntegrityIdrFrameRatio),
        ("motion_integrity_forced_idr_requested_count={0}" -f $Summary.LatestMotionIntegrityForcedIdrRequestedCount),
        ("motion_integrity_forced_idr_confirmed_count={0}" -f $Summary.LatestMotionIntegrityForcedIdrConfirmedCount),
        ("motion_integrity_forced_idr_missed_count={0}" -f $Summary.LatestMotionIntegrityForcedIdrMissedCount),
        ("motion_integrity_forced_idr_pending_count={0}" -f $Summary.LatestMotionIntegrityForcedIdrPendingCount),
        ("motion_integrity_forced_idr_consecutive_miss_count={0}" -f $Summary.LatestMotionIntegrityForcedIdrConsecutiveMissCount),
        ("motion_integrity_forced_idr_burst_miss_count={0}" -f $Summary.LatestMotionIntegrityForcedIdrBurstMissCount),
        ("motion_integrity_active_idr_frame_ratio={0}" -f $Summary.LatestMotionIntegrityActiveIdrFrameRatio),
        ("motion_integrity_forced_idr_last_miss_reason={0}" -f $Summary.LatestMotionIntegrityForcedIdrLastMissReason),
        ("motion_integrity_encoder_rebuild_count={0}" -f $Summary.LatestMotionIntegrityEncoderRebuildCount),
        ("motion_integrity_encoder_rebuild_suppressed_count={0}" -f $Summary.LatestMotionIntegrityEncoderRebuildSuppressedCount),
        ("motion_integrity_encoder_rebuild_pending={0}" -f $Summary.LatestMotionIntegrityEncoderRebuildPending),
        ("motion_integrity_encoder_rebuild_last_reason={0}" -f $Summary.LatestMotionIntegrityEncoderRebuildLastReason),
        ("cursor_capture_enabled={0}" -f $Summary.LatestCursorCaptureEnabled),
        ("cursor_capture_desired_enabled={0}" -f $Summary.LatestCursorCaptureDesiredEnabled),
        ("cursor_capture_control_supported={0}" -f $Summary.LatestCursorCaptureControlSupported),
        ("cursor_capture_apply_status={0}" -f $Summary.LatestCursorCaptureApplyStatus),
        ("cursor_capture_fallback_reason={0}" -f $Summary.LatestCursorCaptureFallbackReason),
        ("cursor_delivery_mode={0}" -f $Summary.LatestHelperCursorDeliveryMode),
        ("cursor_sender_delivery_mode={0}" -f $Summary.LatestCursorDeliveryMode),
        ("cursor_overlay_updates_sent_count={0}" -f $Summary.LatestCursorOverlayUpdatesSentCount),
        ("cursor_overlay_send_failure_count={0}" -f $Summary.LatestCursorOverlaySendFailureCount),
        ("cursor_overlay_mapping_failure_count={0}" -f $Summary.LatestCursorOverlayMappingFailureCount),
        ("cursor_overlay_sender_last_status={0}" -f $Summary.LatestCursorOverlayLastStatus),
        ("cursor_overlay_visible={0}" -f $Summary.LatestHelperCursorOverlayVisible),
        ("cursor_overlay_updates_received_count={0}" -f $Summary.LatestHelperCursorOverlayUpdatesReceivedCount),
        ("cursor_overlay_updates_applied_count={0}" -f $Summary.LatestHelperCursorOverlayUpdatesAppliedCount),
        ("cursor_overlay_update_hz={0}" -f $Summary.LatestHelperCursorOverlayUpdateHz),
