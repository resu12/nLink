function Get-SoakSummaryFromLog {
    ...
    $latestRawCaptureEventCount = -1
    $latestRawFramesSkippedBeforeEncode = -1
    $latestRawEncodeSlotEmptyCount = -1
    $latestRawSlotCoalescingActive = -1
    $latestRawSourceFrameArrivedCount = -1
    $latestRawSourceFramesSkippedBeforeReadback = -1
    $latestRawSourceFramesReadbackCount = -1
    $latestRawSourceReadbackFps = -1.0
    $latestRawSourceLastReadbackDurationMs = -1
    $latestRawSourceAvgReadbackDurationMs = -1.0
    $latestRawSourceCadenceTargetFps = -1
    $latestRawSourceUrgentBypassCount = -1
    $latestRawSourceOutputWidth = -1
    $latestRawSourceOutputHeight = -1
    $latestRawSourceGpuScaleEnabled = -1
    $latestRawSourceGpuScaleFallbackReason = '(none)'
    $latestActualEncodedDisplayableFps = -1.0
    $latestEncodeCadenceTargetFps = -1
    $latestSenderProcessCpuPercent = -1.0
    ...
    $latestMotionIntegrityGuardActive = 0
    $latestMotionIntegritySampledRatio = -1.0
    $latestMotionIntegrityPeakSampledRatio = -1.0
    $latestMotionIntegrityScrollActiveBandCount = -1
    $latestMotionIntegrityScrollPeakBandRatio = -1.0
    $latestMotionIntegrityHighMotionFrameCount = -1
    $latestMotionIntegrityScrollTriggerCount = -1
    $latestMotionIntegrityBurstEnterCount = -1
    $latestMotionIntegrityBurstExitCount = -1
    $latestMotionIntegrityForcedKeyFrameCount = -1
    $latestMotionIntegrityLastTriggerKind = 'none'
    $latestMotionIntegrityLastReason = 'none'
    $latestMotionIntegrityIdrFrameRatio = -1.0
    $latestMotionIntegrityForcedIdrRequestedCount = -1
    $latestMotionIntegrityForcedIdrConfirmedCount = -1
    $latestMotionIntegrityForcedIdrMissedCount = -1
    $latestMotionIntegrityForcedIdrPendingCount = -1
    $latestMotionIntegrityForcedIdrConsecutiveMissCount = -1
    $latestMotionIntegrityForcedIdrBurstMissCount = -1
    $latestMotionIntegrityActiveIdrFrameRatio = -1.0
    $latestMotionIntegrityForcedIdrLastMissReason = 'none'
    $latestMotionIntegrityEncoderRebuildCount = -1
    $latestMotionIntegrityEncoderRebuildSuppressedCount = -1
    $latestMotionIntegrityEncoderRebuildPending = 0
    $latestMotionIntegrityEncoderRebuildLastReason = 'none'
    $latestCursorCaptureEnabled = -1
    $latestCursorCaptureDesiredEnabled = -1
    $latestCursorCaptureControlSupported = -1
    $latestCursorCaptureApplyStatus = '(none)'
    $latestCursorCaptureFallbackReason = '(none)'
    $latestCursorDeliveryMode = 'captured_video'
    $latestCursorOverlayUpdatesSentCount = -1
    $latestCursorOverlaySendFailureCount = -1
    $latestCursorOverlayMappingFailureCount = -1
    $latestCursorOverlayLastStatus = '(none)'
    ...
    $latestLastPreprocessResizeDurationMs = -1
    $latestLastPreprocessColorConvertDurationMs = -1
    $latestPreprocessResizePath = '(none)'
    $latestPreprocessDirectNv12Count = -1
    ...
    $latestHelperH264ReferenceTaintActive = 0
    $latestHelperH264ReferenceTaintEnterCount = -1
    $latestHelperH264ReferenceTaintReleaseCount = -1
    $latestHelperH264ReferenceTaintLastReason = 'none'
    $latestHelperH264ReferenceTaintDroppedNonKeyCount = -1
    $latestHelperH264ReferenceTaintDecoderResetCount = -1
    $latestHelperH264ReferenceTaintStaleVisibleStableEnterCount = -1
    $latestHelperStaleNormalNonKeyVisibleSuppressCount = -1
    $latestHelperDecodedStaleVisibleSuppressCount = -1
    $latestHelperPostQuarantineSettleSuppressCount = -1
    $latestHelperH264ReferenceQuarantineActive = 0
    $latestHelperH264ReferenceQuarantineReleaseBlockedCount = -1
    $latestHelperH264ReferenceQuarantineLastBlocker = 'none'
    $latestHelperH264ReferenceQuarantineQuietReleaseCount = -1
    $latestHelperCursorDeliveryMode = 'captured_video'
    $latestHelperCursorOverlayVisible = -1
    $latestHelperCursorOverlayUpdatesReceivedCount = -1
    $latestHelperCursorOverlayUpdatesAppliedCount = -1
    $latestHelperCursorOverlayUpdateHz = -1.0
    $latestHelperCursorOverlayLastAgeMs = -1
    $latestHelperCursorOverlayStaleCount = -1
    $latestHelperCursorOverlayLastStatus = '(none)'
    ...
    $helperH264ReferenceTaintSummaryLines = New-Object System.Collections.Generic.List[string]
    ...
    foreach ($line in [System.IO.File]::ReadAllLines($logPath)) {
        ...
        if ($line -like '*event=screenshare_freshness_summary;*') {
            ...
            $latestRawCaptureEventCount = Get-StructuredLogIntField -Pairs $pairs -Key 'raw_capture_event_count' -DefaultValue $latestRawCaptureEventCount
            $latestRawFramesSkippedBeforeEncode = Get-StructuredLogIntField -Pairs $pairs -Key 'raw_frames_skipped_before_encode' -DefaultValue $latestRawFramesSkippedBeforeEncode
            ...
            $latestRawSourceFrameArrivedCount = Get-StructuredLogIntField -Pairs $pairs -Key 'raw_source_frame_arrived_count' -DefaultValue $latestRawSourceFrameArrivedCount
            $latestRawSourceFramesSkippedBeforeReadback = Get-StructuredLogIntField -Pairs $pairs -Key 'raw_source_frames_skipped_before_readback' -DefaultValue $latestRawSourceFramesSkippedBeforeReadback
            $latestRawSourceFramesReadbackCount = Get-StructuredLogIntField -Pairs $pairs -Key 'raw_source_frames_readback_count' -DefaultValue $latestRawSourceFramesReadbackCount
            $latestRawSourceReadbackFps = Get-StructuredLogFloatField -Pairs $pairs -Key 'raw_source_readback_fps' -DefaultValue $latestRawSourceReadbackFps
            $latestRawSourceLastReadbackDurationMs = Get-StructuredLogIntField -Pairs $pairs -Key 'raw_source_last_readback_duration_ms' -DefaultValue $latestRawSourceLastReadbackDurationMs
            $latestRawSourceAvgReadbackDurationMs = Get-StructuredLogFloatField -Pairs $pairs -Key 'raw_source_avg_readback_duration_ms' -DefaultValue $latestRawSourceAvgReadbackDurationMs
            $latestRawSourceCadenceTargetFps = Get-StructuredLogIntField -Pairs $pairs -Key 'raw_source_cadence_target_fps' -DefaultValue $latestRawSourceCadenceTargetFps
            $latestRawSourceUrgentBypassCount = Get-StructuredLogIntField -Pairs $pairs -Key 'raw_source_urgent_bypass_count' -DefaultValue $latestRawSourceUrgentBypassCount
            $latestRawSourceOutputWidth = Get-StructuredLogIntField -Pairs $pairs -Key 'raw_source_output_width' -DefaultValue $latestRawSourceOutputWidth
            $latestRawSourceOutputHeight = Get-StructuredLogIntField -Pairs $pairs -Key 'raw_source_output_height' -DefaultValue $latestRawSourceOutputHeight
            $latestRawSourceGpuScaleEnabled = Get-StructuredLogIntField -Pairs $pairs -Key 'raw_source_gpu_scale_enabled' -DefaultValue $latestRawSourceGpuScaleEnabled
            $latestRawSourceGpuScaleFallbackReason = Get-StructuredLogStringField -Pairs $pairs -Key 'raw_source_gpu_scale_fallback_reason' -DefaultValue $latestRawSourceGpuScaleFallbackReason
            $latestActualEncodedDisplayableFps = Get-StructuredLogFloatField -Pairs $pairs -Key 'actual_encoded_displayable_fps' -DefaultValue $latestActualEncodedDisplayableFps
            $latestEncodeCadenceTargetFps = Get-StructuredLogIntField -Pairs $pairs -Key 'encode_cadence_target_fps' -DefaultValue $latestEncodeCadenceTargetFps
            $latestSenderProcessCpuPercent = Get-StructuredLogFloatField -Pairs $pairs -Key 'sender_process_cpu_percent' -DefaultValue $latestSenderProcessCpuPercent
            ...
            $latestMotionIntegrityGuardActive = Get-StructuredLogIntField -Pairs $pairs -Key 'motion_integrity_guard_active' -DefaultValue $latestMotionIntegrityGuardActive
            $latestMotionIntegritySampledRatio = Get-StructuredLogFloatField -Pairs $pairs -Key 'motion_integrity_sampled_ratio' -DefaultValue $latestMotionIntegritySampledRatio
            $latestMotionIntegrityPeakSampledRatio = Get-StructuredLogFloatField -Pairs $pairs -Key 'motion_integrity_peak_sampled_ratio' -DefaultValue $latestMotionIntegrityPeakSampledRatio
            $latestMotionIntegrityScrollActiveBandCount = Get-StructuredLogIntField -Pairs $pairs -Key 'motion_integrity_scroll_active_band_count' -DefaultValue $latestMotionIntegrityScrollActiveBandCount
            $latestMotionIntegrityScrollPeakBandRatio = Get-StructuredLogFloatField -Pairs $pairs -Key 'motion_integrity_scroll_peak_band_ratio' -DefaultValue $latestMotionIntegrityScrollPeakBandRatio
            $latestMotionIntegrityHighMotionFrameCount = Get-StructuredLogIntField -Pairs $pairs -Key 'motion_integrity_high_motion_frame_count' -DefaultValue $latestMotionIntegrityHighMotionFrameCount
            $latestMotionIntegrityScrollTriggerCount = Get-StructuredLogIntField -Pairs $pairs -Key 'motion_integrity_scroll_trigger_count' -DefaultValue $latestMotionIntegrityScrollTriggerCount
            $latestMotionIntegrityBurstEnterCount = Get-StructuredLogIntField -Pairs $pairs -Key 'motion_integrity_burst_enter_count' -DefaultValue $latestMotionIntegrityBurstEnterCount
            $latestMotionIntegrityBurstExitCount = Get-StructuredLogIntField -Pairs $pairs -Key 'motion_integrity_burst_exit_count' -DefaultValue $latestMotionIntegrityBurstExitCount
            $latestMotionIntegrityForcedKeyFrameCount = Get-StructuredLogIntField -Pairs $pairs -Key 'motion_integrity_forced_keyframe_count' -DefaultValue $latestMotionIntegrityForcedKeyFrameCount
            $latestMotionIntegrityLastTriggerKind = Get-StructuredLogStringField -Pairs $pairs -Key 'motion_integrity_last_trigger_kind' -DefaultValue $latestMotionIntegrityLastTriggerKind
            $latestMotionIntegrityLastReason = Get-StructuredLogStringField -Pairs $pairs -Key 'motion_integrity_last_reason' -DefaultValue $latestMotionIntegrityLastReason
            $latestMotionIntegrityIdrFrameRatio = Get-StructuredLogFloatField -Pairs $pairs -Key 'motion_integrity_idr_frame_ratio' -DefaultValue $latestMotionIntegrityIdrFrameRatio
            $latestMotionIntegrityForcedIdrRequestedCount = Get-StructuredLogIntField -Pairs $pairs -Key 'motion_integrity_forced_idr_requested_count' -DefaultValue $latestMotionIntegrityForcedIdrRequestedCount
            $latestMotionIntegrityForcedIdrConfirmedCount = Get-StructuredLogIntField -Pairs $pairs -Key 'motion_integrity_forced_idr_confirmed_count' -DefaultValue $latestMotionIntegrityForcedIdrConfirmedCount
            $latestMotionIntegrityForcedIdrMissedCount = Get-StructuredLogIntField -Pairs $pairs -Key 'motion_integrity_forced_idr_missed_count' -DefaultValue $latestMotionIntegrityForcedIdrMissedCount
            $latestMotionIntegrityForcedIdrPendingCount = Get-StructuredLogIntField -Pairs $pairs -Key 'motion_integrity_forced_idr_pending_count' -DefaultValue $latestMotionIntegrityForcedIdrPendingCount
            $latestMotionIntegrityForcedIdrConsecutiveMissCount = Get-StructuredLogIntField -Pairs $pairs -Key 'motion_integrity_forced_idr_consecutive_miss_count' -DefaultValue $latestMotionIntegrityForcedIdrConsecutiveMissCount
            $latestMotionIntegrityForcedIdrBurstMissCount = Get-StructuredLogIntField -Pairs $pairs -Key 'motion_integrity_forced_idr_burst_miss_count' -DefaultValue $latestMotionIntegrityForcedIdrBurstMissCount
            $latestMotionIntegrityActiveIdrFrameRatio = Get-StructuredLogFloatField -Pairs $pairs -Key 'motion_integrity_active_idr_frame_ratio' -DefaultValue $latestMotionIntegrityActiveIdrFrameRatio
            $latestMotionIntegrityForcedIdrLastMissReason = Get-StructuredLogStringField -Pairs $pairs -Key 'motion_integrity_forced_idr_last_miss_reason' -DefaultValue $latestMotionIntegrityForcedIdrLastMissReason
            $latestMotionIntegrityEncoderRebuildCount = Get-StructuredLogIntField -Pairs $pairs -Key 'motion_integrity_encoder_rebuild_count' -DefaultValue $latestMotionIntegrityEncoderRebuildCount
            $latestMotionIntegrityEncoderRebuildSuppressedCount = Get-StructuredLogIntField -Pairs $pairs -Key 'motion_integrity_encoder_rebuild_suppressed_count' -DefaultValue $latestMotionIntegrityEncoderRebuildSuppressedCount
            $latestMotionIntegrityEncoderRebuildPending = Get-StructuredLogIntField -Pairs $pairs -Key 'motion_integrity_encoder_rebuild_pending' -DefaultValue $latestMotionIntegrityEncoderRebuildPending
            $latestMotionIntegrityEncoderRebuildLastReason = Get-StructuredLogStringField -Pairs $pairs -Key 'motion_integrity_encoder_rebuild_last_reason' -DefaultValue $latestMotionIntegrityEncoderRebuildLastReason
            $latestCursorCaptureEnabled = Get-StructuredLogIntField -Pairs $pairs -Key 'cursor_capture_enabled' -DefaultValue $latestCursorCaptureEnabled
            $latestCursorCaptureDesiredEnabled = Get-StructuredLogIntField -Pairs $pairs -Key 'cursor_capture_desired_enabled' -DefaultValue $latestCursorCaptureDesiredEnabled
            $latestCursorCaptureControlSupported = Get-StructuredLogIntField -Pairs $pairs -Key 'cursor_capture_control_supported' -DefaultValue $latestCursorCaptureControlSupported
            $latestCursorCaptureApplyStatus = Get-StructuredLogStringField -Pairs $pairs -Key 'cursor_capture_apply_status' -DefaultValue $latestCursorCaptureApplyStatus
            $latestCursorCaptureFallbackReason = Get-StructuredLogStringField -Pairs $pairs -Key 'cursor_capture_fallback_reason' -DefaultValue $latestCursorCaptureFallbackReason
            $latestCursorDeliveryMode = Get-StructuredLogStringField -Pairs $pairs -Key 'cursor_delivery_mode' -DefaultValue $latestCursorDeliveryMode
            $latestCursorOverlayUpdatesSentCount = Get-StructuredLogIntField -Pairs $pairs -Key 'cursor_overlay_updates_sent_count' -DefaultValue $latestCursorOverlayUpdatesSentCount
            $latestCursorOverlaySendFailureCount = Get-StructuredLogIntField -Pairs $pairs -Key 'cursor_overlay_send_failure_count' -DefaultValue $latestCursorOverlaySendFailureCount
            $latestCursorOverlayMappingFailureCount = Get-StructuredLogIntField -Pairs $pairs -Key 'cursor_overlay_mapping_failure_count' -DefaultValue $latestCursorOverlayMappingFailureCount
            $latestCursorOverlayLastStatus = Get-StructuredLogStringField -Pairs $pairs -Key 'cursor_overlay_last_status' -DefaultValue $latestCursorOverlayLastStatus
            ...
            $latestLastPreprocessResizeDurationMs = Get-StructuredLogIntField -Pairs $pairs -Key 'last_preprocess_resize_duration_ms' -DefaultValue $latestLastPreprocessResizeDurationMs
            $latestLastPreprocessColorConvertDurationMs = Get-StructuredLogIntField -Pairs $pairs -Key 'last_preprocess_color_convert_duration_ms' -DefaultValue $latestLastPreprocessColorConvertDurationMs
            $latestPreprocessResizePath = Get-StructuredLogStringField -Pairs $pairs -Key 'preprocess_resize_path' -DefaultValue $latestPreprocessResizePath
            $latestPreprocessDirectNv12Count = Get-StructuredLogIntField -Pairs $pairs -Key 'preprocess_direct_nv12_count' -DefaultValue $latestPreprocessDirectNv12Count
        ...
        if ($line -like '*event=screenshare_helper_h264_reference_taint_summary; role=helper_remote;*') {
            [void]$helperH264ReferenceTaintSummaryLines.Add($line)
            while ($helperH264ReferenceTaintSummaryLines.Count -gt 8) {
                $helperH264ReferenceTaintSummaryLines.RemoveAt(0)
            }

            $pairs = Get-StructuredLogFieldPairs -Line $line
            $latestHelperH264ReferenceTaintActive = Get-StructuredLogIntField -Pairs $pairs -Key 'h264_reference_taint_active' -DefaultValue $latestHelperH264ReferenceTaintActive
            $latestHelperH264ReferenceTaintEnterCount = Get-StructuredLogIntField -Pairs $pairs -Key 'h264_reference_taint_enter_count' -DefaultValue $latestHelperH264ReferenceTaintEnterCount
            $latestHelperH264ReferenceTaintReleaseCount = Get-StructuredLogIntField -Pairs $pairs -Key 'h264_reference_taint_release_count' -DefaultValue $latestHelperH264ReferenceTaintReleaseCount
            $latestHelperH264ReferenceTaintLastReason = Get-StructuredLogStringField -Pairs $pairs -Key 'h264_reference_taint_last_reason' -DefaultValue $latestHelperH264ReferenceTaintLastReason
            $latestHelperH264ReferenceTaintDroppedNonKeyCount = Get-StructuredLogIntField -Pairs $pairs -Key 'h264_reference_taint_dropped_non_key_count' -DefaultValue $latestHelperH264ReferenceTaintDroppedNonKeyCount
            $latestHelperH264ReferenceTaintDecoderResetCount = Get-StructuredLogIntField -Pairs $pairs -Key 'h264_reference_taint_decoder_reset_count' -DefaultValue $latestHelperH264ReferenceTaintDecoderResetCount
            $latestHelperH264ReferenceTaintStaleVisibleStableEnterCount = Get-StructuredLogIntField -Pairs $pairs -Key 'h264_reference_taint_stale_visible_stable_enter_count' -DefaultValue $latestHelperH264ReferenceTaintStaleVisibleStableEnterCount
            $latestHelperStaleNormalNonKeyVisibleSuppressCount = Get-StructuredLogIntField -Pairs $pairs -Key 'stale_normal_non_key_visible_suppress_count' -DefaultValue $latestHelperStaleNormalNonKeyVisibleSuppressCount
            $latestHelperDecodedStaleVisibleSuppressCount = Get-StructuredLogIntField -Pairs $pairs -Key 'decoded_stale_visible_suppress_count' -DefaultValue $latestHelperDecodedStaleVisibleSuppressCount
            $latestHelperPostQuarantineSettleSuppressCount = Get-StructuredLogIntField -Pairs $pairs -Key 'post_quarantine_settle_suppress_count' -DefaultValue $latestHelperPostQuarantineSettleSuppressCount
            $latestHelperH264ReferenceQuarantineActive = Get-StructuredLogIntField -Pairs $pairs -Key 'h264_reference_quarantine_active' -DefaultValue $latestHelperH264ReferenceQuarantineActive
            $latestHelperH264ReferenceQuarantineReleaseBlockedCount = Get-StructuredLogIntField -Pairs $pairs -Key 'h264_reference_quarantine_release_blocked_count' -DefaultValue $latestHelperH264ReferenceQuarantineReleaseBlockedCount
            $latestHelperH264ReferenceQuarantineLastBlocker = Get-StructuredLogStringField -Pairs $pairs -Key 'h264_reference_quarantine_last_blocker' -DefaultValue $latestHelperH264ReferenceQuarantineLastBlocker
            $latestHelperH264ReferenceQuarantineQuietReleaseCount = Get-StructuredLogIntField -Pairs $pairs -Key 'h264_reference_quarantine_quiet_release_count' -DefaultValue $latestHelperH264ReferenceQuarantineQuietReleaseCount
        }
        ...
        if ($line -like '*event=screenshare_helper_quality_summary; role=helper_remote;*') {
            ...
            $latestSummaryHelperRecoveryMechanism = Get-StructuredLogStringField -Pairs $pairs -Key 'helper_recovery_mechanism' -DefaultValue $latestSummaryHelperRecoveryMechanism
            $latestSummaryDominantLossClass = Get-StructuredLogStringField -Pairs $pairs -Key 'dominant_loss_class' -DefaultValue $latestSummaryDominantLossClass
            $latestHelperCursorDeliveryMode = Get-StructuredLogStringField -Pairs $pairs -Key 'cursor_delivery_mode' -DefaultValue $latestHelperCursorDeliveryMode
            $latestHelperCursorOverlayVisible = Get-StructuredLogIntField -Pairs $pairs -Key 'cursor_overlay_visible' -DefaultValue $latestHelperCursorOverlayVisible
            $latestHelperCursorOverlayUpdatesReceivedCount = Get-StructuredLogIntField -Pairs $pairs -Key 'cursor_overlay_updates_received_count' -DefaultValue $latestHelperCursorOverlayUpdatesReceivedCount
            $latestHelperCursorOverlayUpdatesAppliedCount = Get-StructuredLogIntField -Pairs $pairs -Key 'cursor_overlay_updates_applied_count' -DefaultValue $latestHelperCursorOverlayUpdatesAppliedCount
            $latestHelperCursorOverlayUpdateHz = Get-StructuredLogFloatField -Pairs $pairs -Key 'cursor_overlay_update_hz' -DefaultValue $latestHelperCursorOverlayUpdateHz
            $latestHelperCursorOverlayLastAgeMs = Get-StructuredLogIntField -Pairs $pairs -Key 'cursor_overlay_last_age_ms' -DefaultValue $latestHelperCursorOverlayLastAgeMs
            $latestHelperCursorOverlayStaleCount = Get-StructuredLogIntField -Pairs $pairs -Key 'cursor_overlay_stale_count' -DefaultValue $latestHelperCursorOverlayStaleCount
            $latestHelperCursorOverlayLastStatus = Get-StructuredLogStringField -Pairs $pairs -Key 'cursor_overlay_last_status' -DefaultValue $latestHelperCursorOverlayLastStatus
    ...
    return [pscustomobject]@{
        ...
        LatestRawCaptureEventCount = $latestRawCaptureEventCount
        LatestRawFramesSkippedBeforeEncode = $latestRawFramesSkippedBeforeEncode
        LatestRawEncodeSlotEmptyCount = $latestRawEncodeSlotEmptyCount
        LatestRawSlotCoalescingActive = $latestRawSlotCoalescingActive
        LatestRawSourceFrameArrivedCount = $latestRawSourceFrameArrivedCount
        LatestRawSourceFramesSkippedBeforeReadback = $latestRawSourceFramesSkippedBeforeReadback
        LatestRawSourceFramesReadbackCount = $latestRawSourceFramesReadbackCount
        LatestRawSourceReadbackFps = if ($latestRawSourceReadbackFps -ge 0) { [math]::Round($latestRawSourceReadbackFps, 2) } else { -1 }
        LatestRawSourceLastReadbackDurationMs = $latestRawSourceLastReadbackDurationMs
        LatestRawSourceAvgReadbackDurationMs = if ($latestRawSourceAvgReadbackDurationMs -ge 0) { [math]::Round($latestRawSourceAvgReadbackDurationMs, 1) } else { -1 }
        LatestRawSourceCadenceTargetFps = $latestRawSourceCadenceTargetFps
        LatestRawSourceUrgentBypassCount = $latestRawSourceUrgentBypassCount
        LatestRawSourceOutputWidth = $latestRawSourceOutputWidth
        LatestRawSourceOutputHeight = $latestRawSourceOutputHeight
        LatestRawSourceGpuScaleEnabled = $latestRawSourceGpuScaleEnabled
        LatestRawSourceGpuScaleFallbackReason = $latestRawSourceGpuScaleFallbackReason
        LatestActualEncodedDisplayableFps = if ($latestActualEncodedDisplayableFps -ge 0) { [math]::Round($latestActualEncodedDisplayableFps, 2) } else { -1 }
        LatestEncodeCadenceTargetFps = $latestEncodeCadenceTargetFps
        LatestSenderProcessCpuPercent = if ($latestSenderProcessCpuPercent -ge 0) { [math]::Round($latestSenderProcessCpuPercent, 1) } else { -1 }
        ...
        LatestMotionIntegrityGuardActive = [Math]::Max(0, $latestMotionIntegrityGuardActive)
        LatestMotionIntegritySampledRatio = if ($latestMotionIntegritySampledRatio -ge 0) { [math]::Round($latestMotionIntegritySampledRatio, 3) } else { -1 }
        LatestMotionIntegrityPeakSampledRatio = if ($latestMotionIntegrityPeakSampledRatio -ge 0) { [math]::Round($latestMotionIntegrityPeakSampledRatio, 3) } else { -1 }
        LatestMotionIntegrityScrollActiveBandCount = [Math]::Max(0, $latestMotionIntegrityScrollActiveBandCount)
        LatestMotionIntegrityScrollPeakBandRatio = if ($latestMotionIntegrityScrollPeakBandRatio -ge 0) { [math]::Round($latestMotionIntegrityScrollPeakBandRatio, 3) } else { -1 }
        LatestMotionIntegrityHighMotionFrameCount = [Math]::Max(0, $latestMotionIntegrityHighMotionFrameCount)
        LatestMotionIntegrityScrollTriggerCount = [Math]::Max(0, $latestMotionIntegrityScrollTriggerCount)
        LatestMotionIntegrityBurstEnterCount = [Math]::Max(0, $latestMotionIntegrityBurstEnterCount)
        LatestMotionIntegrityBurstExitCount = [Math]::Max(0, $latestMotionIntegrityBurstExitCount)
        LatestMotionIntegrityForcedKeyFrameCount = [Math]::Max(0, $latestMotionIntegrityForcedKeyFrameCount)
        LatestMotionIntegrityLastTriggerKind = if ([string]::IsNullOrWhiteSpace($latestMotionIntegrityLastTriggerKind)) { 'none' } else { $latestMotionIntegrityLastTriggerKind }
        LatestMotionIntegrityLastReason = if ([string]::IsNullOrWhiteSpace($latestMotionIntegrityLastReason)) { 'none' } else { $latestMotionIntegrityLastReason }
        LatestMotionIntegrityIdrFrameRatio = if ($latestMotionIntegrityIdrFrameRatio -ge 0) { [math]::Round($latestMotionIntegrityIdrFrameRatio, 2) } else { -1 }
        LatestMotionIntegrityForcedIdrRequestedCount = [Math]::Max(0, $latestMotionIntegrityForcedIdrRequestedCount)
        LatestMotionIntegrityForcedIdrConfirmedCount = [Math]::Max(0, $latestMotionIntegrityForcedIdrConfirmedCount)
        LatestMotionIntegrityForcedIdrMissedCount = [Math]::Max(0, $latestMotionIntegrityForcedIdrMissedCount)
        LatestMotionIntegrityForcedIdrPendingCount = [Math]::Max(0, $latestMotionIntegrityForcedIdrPendingCount)
        LatestMotionIntegrityForcedIdrConsecutiveMissCount = [Math]::Max(0, $latestMotionIntegrityForcedIdrConsecutiveMissCount)
        LatestMotionIntegrityForcedIdrBurstMissCount = [Math]::Max(0, $latestMotionIntegrityForcedIdrBurstMissCount)
        LatestMotionIntegrityActiveIdrFrameRatio = if ($latestMotionIntegrityActiveIdrFrameRatio -ge 0) { [math]::Round($latestMotionIntegrityActiveIdrFrameRatio, 2) } else { -1 }
        LatestMotionIntegrityForcedIdrLastMissReason = if ([string]::IsNullOrWhiteSpace($latestMotionIntegrityForcedIdrLastMissReason)) { 'none' } else { $latestMotionIntegrityForcedIdrLastMissReason }
        LatestMotionIntegrityEncoderRebuildCount = [Math]::Max(0, $latestMotionIntegrityEncoderRebuildCount)
        LatestMotionIntegrityEncoderRebuildSuppressedCount = [Math]::Max(0, $latestMotionIntegrityEncoderRebuildSuppressedCount)
        LatestMotionIntegrityEncoderRebuildPending = [Math]::Max(0, $latestMotionIntegrityEncoderRebuildPending)
        LatestMotionIntegrityEncoderRebuildLastReason = if ([string]::IsNullOrWhiteSpace($latestMotionIntegrityEncoderRebuildLastReason)) { 'none' } else { $latestMotionIntegrityEncoderRebuildLastReason }
        LatestCursorCaptureEnabled = $latestCursorCaptureEnabled
        LatestCursorCaptureDesiredEnabled = $latestCursorCaptureDesiredEnabled
        LatestCursorCaptureControlSupported = $latestCursorCaptureControlSupported
        LatestCursorCaptureApplyStatus = if ([string]::IsNullOrWhiteSpace($latestCursorCaptureApplyStatus)) { '(none)' } else { $latestCursorCaptureApplyStatus }
        LatestCursorCaptureFallbackReason = if ([string]::IsNullOrWhiteSpace($latestCursorCaptureFallbackReason)) { '(none)' } else { $latestCursorCaptureFallbackReason }
        LatestCursorDeliveryMode = if ([string]::IsNullOrWhiteSpace($latestCursorDeliveryMode)) { 'captured_video' } else { $latestCursorDeliveryMode }
        LatestCursorOverlayUpdatesSentCount = [Math]::Max(0, $latestCursorOverlayUpdatesSentCount)
        LatestCursorOverlaySendFailureCount = [Math]::Max(0, $latestCursorOverlaySendFailureCount)
        LatestCursorOverlayMappingFailureCount = [Math]::Max(0, $latestCursorOverlayMappingFailureCount)
        LatestCursorOverlayLastStatus = if ([string]::IsNullOrWhiteSpace($latestCursorOverlayLastStatus)) { '(none)' } else { $latestCursorOverlayLastStatus }
        ...
        LatestLastPreprocessResizeDurationMs = $latestLastPreprocessResizeDurationMs
        LatestLastPreprocessColorConvertDurationMs = $latestLastPreprocessColorConvertDurationMs
        LatestPreprocessResizePath = $latestPreprocessResizePath
        LatestPreprocessDirectNv12Count = $latestPreprocessDirectNv12Count
        ...
        LatestHelperH264ReferenceTaintActive = [Math]::Max(0, $latestHelperH264ReferenceTaintActive)
        LatestHelperH264ReferenceTaintEnterCount = [Math]::Max(0, $latestHelperH264ReferenceTaintEnterCount)
        LatestHelperH264ReferenceTaintReleaseCount = [Math]::Max(0, $latestHelperH264ReferenceTaintReleaseCount)
        LatestHelperH264ReferenceTaintLastReason = if ([string]::IsNullOrWhiteSpace($latestHelperH264ReferenceTaintLastReason)) { 'none' } else { $latestHelperH264ReferenceTaintLastReason }
        LatestHelperH264ReferenceTaintDroppedNonKeyCount = [Math]::Max(0, $latestHelperH264ReferenceTaintDroppedNonKeyCount)
        LatestHelperH264ReferenceTaintDecoderResetCount = [Math]::Max(0, $latestHelperH264ReferenceTaintDecoderResetCount)
        LatestHelperH264ReferenceTaintStaleVisibleStableEnterCount = [Math]::Max(0, $latestHelperH264ReferenceTaintStaleVisibleStableEnterCount)
        LatestHelperStaleNormalNonKeyVisibleSuppressCount = [Math]::Max(0, $latestHelperStaleNormalNonKeyVisibleSuppressCount)
        LatestHelperDecodedStaleVisibleSuppressCount = [Math]::Max(0, $latestHelperDecodedStaleVisibleSuppressCount)
        LatestHelperPostQuarantineSettleSuppressCount = [Math]::Max(0, $latestHelperPostQuarantineSettleSuppressCount)
        LatestHelperH264ReferenceQuarantineActive = [Math]::Max(0, $latestHelperH264ReferenceQuarantineActive)
        LatestHelperH264ReferenceQuarantineReleaseBlockedCount = [Math]::Max(0, $latestHelperH264ReferenceQuarantineReleaseBlockedCount)
        LatestHelperH264ReferenceQuarantineLastBlocker = if ([string]::IsNullOrWhiteSpace($latestHelperH264ReferenceQuarantineLastBlocker)) { 'none' } else { $latestHelperH264ReferenceQuarantineLastBlocker }
        LatestHelperH264ReferenceQuarantineQuietReleaseCount = [Math]::Max(0, $latestHelperH264ReferenceQuarantineQuietReleaseCount)
        LatestHelperCursorDeliveryMode = if ([string]::IsNullOrWhiteSpace($latestHelperCursorDeliveryMode)) { 'captured_video' } else { $latestHelperCursorDeliveryMode }
        LatestHelperCursorOverlayVisible = [Math]::Max(0, $latestHelperCursorOverlayVisible)
        LatestHelperCursorOverlayUpdatesReceivedCount = [Math]::Max(0, $latestHelperCursorOverlayUpdatesReceivedCount)
        LatestHelperCursorOverlayUpdatesAppliedCount = [Math]::Max(0, $latestHelperCursorOverlayUpdatesAppliedCount)
        LatestHelperCursorOverlayUpdateHz = if ($latestHelperCursorOverlayUpdateHz -ge 0) { [math]::Round($latestHelperCursorOverlayUpdateHz, 1) } else { -1 }
        LatestHelperCursorOverlayLastAgeMs = $latestHelperCursorOverlayLastAgeMs
        LatestHelperCursorOverlayStaleCount = [Math]::Max(0, $latestHelperCursorOverlayStaleCount)
        LatestHelperCursorOverlayLastStatus = if ([string]::IsNullOrWhiteSpace($latestHelperCursorOverlayLastStatus)) { '(none)' } else { $latestHelperCursorOverlayLastStatus }
        ...
        HelperH264ReferenceTaintSummaryLines = @($helperH264ReferenceTaintSummaryLines.ToArray())
