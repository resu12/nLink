...
function Write-ScreenShareOperatorVerdictReport {
    ...
    if ($null -ne $quality) {
        $qualityKeys = @(
            ...
            "capture_scale",
            "actual_encoded_displayable_fps",
            "encode_cadence_target_fps",
            "sender_process_cpu_percent",
            "last_preprocess_duration_ms",
            "last_preprocess_resize_duration_ms",
            "last_preprocess_color_convert_duration_ms",
            "preprocess_resize_path",
            "preprocess_direct_nv12_count",
            "raw_capture_event_count",
            "raw_frames_skipped_before_encode",
            "raw_source_frame_arrived_count",
            "raw_source_frames_skipped_before_readback",
            "raw_source_frames_readback_count",
            "raw_source_readback_fps",
            "raw_source_last_readback_duration_ms",
            "raw_source_avg_readback_duration_ms",
            "raw_source_cadence_target_fps",
            "raw_source_urgent_bypass_count",
            "raw_source_output_width",
            "raw_source_output_height",
            "raw_source_gpu_scale_enabled",
            "raw_source_gpu_scale_fallback_reason",
            ...
            "h264_reference_taint_active",
            "h264_reference_taint_enter_count",
            "h264_reference_taint_release_count",
            "h264_reference_taint_last_reason",
            "h264_reference_taint_dropped_non_key_count",
            "h264_reference_taint_decoder_reset_count",
            "h264_reference_taint_stale_visible_stable_enter_count",
            "stale_normal_non_key_visible_suppress_count",
            "decoded_stale_visible_suppress_count",
            "post_quarantine_settle_suppress_count",
            "h264_reference_quarantine_active",
            "h264_reference_quarantine_release_blocked_count",
            "h264_reference_quarantine_last_blocker",
            "h264_reference_quarantine_quiet_release_count",
            "motion_integrity_guard_active",
            "motion_integrity_sampled_ratio",
            "motion_integrity_peak_sampled_ratio",
            "motion_integrity_scroll_active_band_count",
            "motion_integrity_scroll_peak_band_ratio",
            "motion_integrity_high_motion_frame_count",
            "motion_integrity_scroll_trigger_count",
            "motion_integrity_burst_enter_count",
            "motion_integrity_burst_exit_count",
            "motion_integrity_forced_keyframe_count",
            "motion_integrity_last_trigger_kind",
            "motion_integrity_last_reason",
            "motion_integrity_idr_frame_ratio",
            "motion_integrity_forced_idr_requested_count",
            "motion_integrity_forced_idr_confirmed_count",
            "motion_integrity_forced_idr_missed_count",
            "motion_integrity_forced_idr_pending_count",
            "motion_integrity_forced_idr_consecutive_miss_count",
            "motion_integrity_forced_idr_burst_miss_count",
            "motion_integrity_active_idr_frame_ratio",
            "motion_integrity_forced_idr_last_miss_reason",
            "motion_integrity_encoder_rebuild_count",
            "motion_integrity_encoder_rebuild_suppressed_count",
            "motion_integrity_encoder_rebuild_pending",
            "motion_integrity_encoder_rebuild_last_reason",
            "cursor_capture_enabled",
            "cursor_capture_desired_enabled",
            "cursor_capture_control_supported",
            "cursor_capture_apply_status",
            "cursor_capture_fallback_reason",
            "cursor_delivery_mode",
            "cursor_sender_delivery_mode",
            "cursor_overlay_updates_sent_count",
            "cursor_overlay_send_failure_count",
            "cursor_overlay_mapping_failure_count",
            "cursor_overlay_sender_last_status",
            "cursor_overlay_visible",
            "cursor_overlay_updates_received_count",
            "cursor_overlay_updates_applied_count",
            "cursor_overlay_update_hz",
            "cursor_overlay_last_age_ms",
            "cursor_overlay_stale_count",
            "cursor_overlay_last_status"
        )
