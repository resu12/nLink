...
public sealed class SessionFileTransferV4ReceiverTests : SessionFileTransferServiceTestBase
{
    ...
    [Fact]
    public async Task V4SparseReceiver_StalledFrontierUsesWiderInitialRepairBurstForLargeTail()
    {
    ...
    [Fact]
    public async Task V4SparseReceiver_DurableAheadInitialRepairUsesWiderFrontierBurst()
    {
    ...
    [Fact]
    public async Task V4SparseReceiver_CapsFrontierMissingRangeBurstAtInitialRepairLimit()
    {
        ...
        FileTransferWriteStreamFactory openWriteStreamAsync)
    {
        ...
        await senderTransport.SendFileTransferSessionOpenAsync(
            ...
            CancellationToken.None);
        await WaitUntilAsync(() => ReadOperationalLogText().Contains($"event=filetransfer_v4_receiver_started; transfer_id={transferId};", StringComparison.Ordinal), timeoutMs: 5000);
