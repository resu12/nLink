...
public sealed class ContractFreezeTests
{
    ...
    {
        AssertApprovedLines(
            Path.Combine("tests", "nLink.SmokeTests.Contracts", "GoldenFiles", "Contracts", "transport-state.approved.txt"),
    ...
    {
        AssertApprovedLines(
            Path.Combine("tests", "nLink.SmokeTests.Contracts", "GoldenFiles", "Contracts", "transport-failure-category.approved.txt"),
    ...
    {
        AssertApprovedLines(
            Path.Combine("tests", "nLink.SmokeTests.Contracts", "GoldenFiles", "Contracts", "metric-names.approved.txt"),
    ...
    public void DiagnosticsSummarySnapshot_Schema_Freeze()
    {
        ...
        AssertApprovedText(
            Path.Combine("tests", "nLink.SmokeTests.Contracts", "GoldenFiles", "Contracts", "diagnostics-summary-snapshot.golden.json"),
            json);
    }
