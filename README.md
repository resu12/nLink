...
## Current Release (0.5.2.1)

`0.5.2.1` is the current release. It continues the stabilization and hardening work after the first native `0.5.0` file-transfer release.
...
- Windows x64 only
- Current release (`0.5.2.1`)
- File transfer in `0.5.2.1` is single-file only. No folders, drag-and-drop, or resume after restart yet.
- Received files are saved into an app-owned folder under `%LOCALAPPDATA%\nLink\transfers\incoming\...`
- Safe-by-default file size cap for `0.5.2.1`: `256 MiB`
...
- Final release notes:
  [`docs/releases/0.5.2.1.md`](docs/releases/0.5.2.1.md)
- GitHub release body:
  [`docs/releases/0.5.2.1-github.md`](docs/releases/0.5.2.1-github.md)
