...
public sealed partial class SessionRuntime
{
    ...
    private void MaybeSendScreenSharePressureStateCore(bool timerDriven)
    {
        ...
        var currentViewerSoftStaleDropCount = Math.Max(0L, helperPressureSnapshot.ViewerSoftStaleDropCount);
        var currentViewerActionableStaleDropCount = Math.Max(0L, currentViewerStaleDropCount - currentViewerSoftStaleDropCount);
        var viewerStaleDropDelta = Math.Max(0L, currentViewerActionableStaleDropCount - lastObservedRemoteScreenShareStaleDrops);
        ...
        var currentEpochSoftStaleDropCount = Math.Max(0L, helperPressureSnapshot.CurrentEpochSoftStaleDropCount);
        var currentEpochActionableStaleDropCount = Math.Max(0L, currentEpochStaleDropCount - currentEpochSoftStaleDropCount);
        ...
        lastObservedRemoteScreenShareStaleDrops = currentViewerActionableStaleDropCount;
        ...
        var trustedVisibleStableProgress =
            ...
            currentEpochActionableStaleDropCount == 0 &&
